...
public class EmpresaDeGestion {
    ...
    public boolean agregarVehiculo(Vehiculo vehiculo) {
        if (buscarVehiculo(vehiculo.getMarca()) == null) {
            ...
            System.out.println("Vehículo con marca " + vehiculo.getMarca() + " ya existe.");
            return false;
        }
    }
    ...
    public boolean actualizarVehiculo(String marca, String modelo, String tipo) {
        Vehiculo vehiculo = buscarVehiculo(marca);
        if (vehiculo != null) {
